...
if(argv[2] == undefined) {
  ...
  if(argv[2] == 'list:outstanding') {
    if(argv[3] == 'asc') {
      let tmp = []
      console.log(`List Task yang belum Selesai Ascending`)
      for (var i = 0; i < data.length; i++) {
      ...
      let tmp = []
      console.log(`List Task yang belum Selesai Descending`)
      for (var i = 0; i < data.length; i++) {
        if(data[i].completed == false) {
          tmp.push(data[i])
          tmp.sort(function(a,b){
  ...
  if(argv[2] == 'list:completed') {
    if(argv[3] == 'asc') {
      let tmp = []
      console.log(`List Task yang sudah Selesai Ascending`)
      for (var i = 0; i < data.length; i++) {
        if(data[i].completed == true) {
          tmp.push(data[i])
          tmp.sort(function(a,b){
      ...
      let tmp = []
      console.log(`List Task yang sudah Selesai Descending`)
      for (var i = 0; i < data.length; i++) {
        if(data[i].completed == true) {
          tmp.push(data[i])
          tmp.sort(function(a,b){
  ...
  if(argv[2] == 'tag') {
    console.log(`Tag ditambahkan pada id ke-${argv[3]}`);
